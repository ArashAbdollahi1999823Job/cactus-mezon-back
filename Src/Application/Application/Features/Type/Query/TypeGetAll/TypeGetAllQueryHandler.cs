...
public class TypeGetAllQueryHandler:IRequestHandler<TypeGetAllQuery,PaginationDto<TypeDto>>
{
    ...
    {
        var typeSearchDto = new TypeSearchDto(req.PageIndex,req.PageSize,req.Id,req.IsActive,req.Name,req.ParentTypeId,req.SortType,req.Slug,req.JustParentTypeId);
