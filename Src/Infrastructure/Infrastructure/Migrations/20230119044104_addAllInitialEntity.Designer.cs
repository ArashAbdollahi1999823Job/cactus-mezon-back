...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230119044104_addAllInitialEntity")]
    partial class addAllInitialEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.InventoryEntity.Inventory", b =>
                {
                    ...
                    b.Property<long>("ShopSellerId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("ShopSellerId");
            ...
            modelBuilder.Entity("Domain.Entities.InventoryEntity.Off", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Shop.ShopSeller", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.InventoryEntity.Inventory", b =>
                {
                    b.HasOne("Domain.Entities.Shop.ShopSeller", "Shop")
                        .WithMany("Inventories")
                        .HasForeignKey("ShopSellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PictureEntity.ShopSellerPicture", b =>
                {
                    b.HasOne("Domain.Entities.Shop.ShopSeller", "ShopSeller")
                        .WithMany("ShopSellerPictures")
                        .HasForeignKey("ShopSellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ShopSeller");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProductEntity.Product", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.InventoryEntity.Off", "Off")
                        .WithMany("Products")
                        .HasForeignKey("OffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
